...
- `app/admin/layout.tsx` configures `AdminShell` navigation, branding, session input, logout callback, and the `AdminI18nProvider` interface locale. The example intentionally sets English independently from stored or content locale.
