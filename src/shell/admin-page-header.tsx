...
export function AdminPageHeader({
  ...
  return (
    <>
      <div className="flex min-h-[var(--admin-header-height)] items-center justify-between gap-4 border-b border-zinc-200 bg-admin-surface-subtle px-4 py-3 dark:border-zinc-800 sm:px-6 lg:px-8">
