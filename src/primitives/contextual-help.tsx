  ...
  return (
    ...
    >
      ...
      <span
        ...
        role="tooltip"
        hidden={!visible}
        className="absolute left-1/2 top-full z-50 mt-2 w-max max-w-64 -translate-x-1/2 rounded-md bg-zinc-950 px-3 py-2 text-xs font-normal leading-5 text-white shadow-lg"
      >
        {children}
      </span>
    </span>
