...
export default function ProductsPage() {
  ...
  return <div className="space-y-6"><header className="flex flex-wrap items-end justify-between gap-4"><div><h1 className="text-2xl font-bold">Products</h1><p className="mt-1 text-sm text-zinc-500">Manage the Northstar Supply catalog and inventory.</p></div><Link href="/shell/products/new" className="rounded-lg bg-brand-600 px-4 py-2.5 text-sm font-semibold text-white hover:bg-brand-500">Add product</Link></header>
