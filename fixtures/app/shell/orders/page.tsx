...
export default function OrdersPage() {
  ...
  return <div className="space-y-6"><header><h1 className="text-2xl font-bold">Orders</h1><p className="mt-1 text-sm text-zinc-500">Review payments, fulfillment, and customer details.</p></header>
