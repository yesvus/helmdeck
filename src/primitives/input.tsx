...
const adminControlClassName =
  "w-full min-w-0 rounded-lg border border-zinc-300 bg-admin-surface px-3 text-sm leading-5 text-zinc-900 outline-none transition-colors placeholder:text-zinc-400 focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20 disabled:cursor-not-allowed disabled:bg-zinc-50 disabled:text-zinc-400 aria-invalid:border-red-500 aria-invalid:focus:ring-red-500";
